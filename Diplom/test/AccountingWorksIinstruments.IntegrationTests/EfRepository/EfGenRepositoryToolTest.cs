...
namespace AccountingWorksIinstruments.IntegrationTests.EfRepository
{
    ...
    class EfGenRepositoryToolTest
    {
        ...
        public void InitializeTestsEntities()
        {
            ...
            var firstEntity = new Tool(name: "Grinder", description: "to work for metal", locationId: 19, nameOfLocation:"RKP");
        ...
        {
            var firstEntity = new Tool(name: "Grinder", description: "to work for metal", locationId: 1, nameOfLocation: "RKP");
        ...
        public void ReadAllAsyncObjects_WhenPropertiesIsNotNull_ThenOutUsListOfEntitiesFromDatabase()
        {
            ...
            {
               new Tool(name: "Grinder", description: "to work for metal", locationId: 19,nameOfLocation:"RKP")
            };
            // Act
        ...
        {
            // Arrange
            var expected = new Tool(name: "Grinder", description:"to work for metal", locationId:19, nameOfLocation: "RKP");
            // Act
